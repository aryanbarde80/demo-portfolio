...
export default function DivineAudio() {
  ...
  return (
    <button 
      onClick={toggleMute}
      className={`fixed top-4 right-4 z-[70] p-2 rounded-full border transition-all duration-300 ${isMuted ? 'border-[#ff003c]/30 text-[#ff003c]/50 bg-black/40' : 'border-[#ffaa44]/50 text-[#ffaa44] bg-[#ffaa44]/10 shadow-[0_0_15px_rgba(255,170,68,0.4)]'}`}
