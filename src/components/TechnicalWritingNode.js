      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap justify-between items-center gap-2 pb-2 border-b border-[#818cf8]/20">
          <div className="flex items-center gap-2">
            <PenTool size={12} className="text-[#fb923c]" />
          ...
          <div className="flex gap-2 text-[9px] sm:text-[10px] mono">
            <span className="text-[#818cf8] bg-[#818cf8]/10 px-2 py-0.5 rounded">{totalArticles} ARTICLES</span>
            <span className="text-[#fb923c] bg-[#fb923c]/10 px-2 py-0.5 rounded">PUBLISHED</span>
          </div>
        </div>

        {/* Description */}
        <div className="relative p-3 bg-gradient-to-r from-[#818cf8]/5 to-transparent border-l-2 border-[#818cf8] rounded-r-lg">
          ...
          <div className="absolute top-0 right-0 w-12 h-12 bg-gradient-to-bl from-[#818cf8]/10 to-transparent pointer-events-none rounded-tr-lg" />
        </div>
          ...
          {blogs.map((blog, idx) => {
            ...
            return (
              <a 
                ...
                className="group relative block border border-gray-800 hover:border-[#818cf8]/50 rounded-lg transition-all duration-300 bg-gradient-to-r from-[#030712] to-transparent hover:bg-[#818cf8]/5 overflow-hidden cursor-pointer"
              >
                {/* Animated Background */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#818cf8]/0 via-[#818cf8]/5 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                
                <div className="relative p-3">
                  <div className="flex justify-between items-start gap-2">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1.5">
                        <IconComponent size={12} className="text-[#818cf8] group-hover:scale-110 transition-transform" />
                        <h4 className="text-xs sm:text-sm font-bold text-gray-200 group-hover:text-[#818cf8] transition-colors truncate">
                          {blog.title}
                        </h4>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        <span className="text-[8px] sm:text-[9px] mono text-[#f472b6] flex items-center gap-1">
                    ...
                    <div className="shrink-0">
                      <ExternalLink size={12} className="text-gray-600 group-hover:text-[#818cf8] transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                    </div>
                  </div>
                </div>
                
                {/* Bottom Accent */}
                <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#818cf8]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </a>
            );
          })}
        </div>
        ...
        <div className="flex flex-wrap justify-between items-center gap-3 pt-3 border-t border-[#818cf8]/20 text-[8px] sm:text-[9px] mono">
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1">
              <TrendingUp size={10} className="text-[#818cf8]" />
              <span className="text-gray-500">TOTAL_VIEWS: 5.2K+</span>
            </span>
            <span className="flex items-center gap-1">
              <BookOpen size={10} className="text-[#fb923c]" />
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block text-center py-2 mt-2 border border-gray-700 hover:border-[#818cf8] rounded-lg text-gray-500 hover:text-[#818cf8] transition-all text-[9px] sm:text-[10px] mono uppercase tracking-wider"
        >
          [ VIEW_MEDIUM_PROFILE → ]
        </a>
      </div>
